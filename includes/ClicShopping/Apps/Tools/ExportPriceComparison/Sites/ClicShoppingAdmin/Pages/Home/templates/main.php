...
<div class="contentBody">
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_ExportPriceComparison->getDef('text_export_price_comparison'); ?></strong></div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <div class="col-md-12">
            <?php echo $CLICSHOPPING_ExportPriceComparison->getDef('text_intro'); ?>
          </div>
        </div>
        <div class="separator"></div>
        ...
        <div class="col-md-12 text-center">
          <div class="form-group">
            <div class="col-md-12">
              <?php
                echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Tools\ExportPriceComparison&Configure'));
                echo HTML::button($CLICSHOPPING_ExportPriceComparison->getDef('button_configure'), null, null, 'primary');
                echo '</form>';
              ?>
            </div>
          </div>
