<?php
   ...
   *
   */
//https://developers.facebook.com/docs/marketing-api/dynamic-product-ads/debugging-tools/v2.5
//https://developers.facebook.com/docs/marketing-api/dynamic-product-ads/product-catalog#productfeed
  ...
  $comp = array("Exportation Facebook XML");
...
//  $output .= '<product place="'.$product_num.'">'."\n";
  ...
  $output .= '<g:google_product_category>' . $categorie_name . '</g:google_product_category>' . chr(10);
  $output .= '<g:link>' . rawurlencode($product_url) . '</g:link>' . chr(10);
